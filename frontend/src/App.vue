<template>
  <div :data-theme="isDarkMode ? 'dark' : 'light'" class="min-h-screen bg-white text-gray-800 dark:bg-black dark:text-white">
    <div class="container m-auto p-4">
      <!-- Header -->
      <header class="flex justify-between items-center pt-4 pb-4 pl-9 pr-10 mb-4 rounded-lg bg-gray-100 dark:bg-gray-800 shadow">
        <div class="logo-container flex items-center">
          <svg id="onyx-logo" fill="white" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 254.84406 393.2533" class="h-6">
      ...
      <footer class="text-center p-4 bg-gray-100 dark:bg-gray-800">
        <p class="text-sm">© 2025 SpaceX Dashboard. All rights reserved.</p>
      </footer>
    </div>
  </div>
</template>
